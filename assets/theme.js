  ...
  var flickity = createCommonjsModule(function (module) {
    ...
    (function (window, factory) {
      ...
      proto._positionCells = function (index) {
        ...
        /*THEME OVERRIDE*/
      	$(document).on('click', '.deeplink', function(e) {
            e.preventDefault();
  ...
  */
  ...
  (function () {
    var bootTheme = function bootTheme() {
      ...
      //sections.register('collection-list', CollectionListSection);				//Removed - theme functionality changed from default theme
      sections.register('collection', CollectionSection);
      //sections.register('featured-collection', FeaturedCollectionSection);		//Removed - theme functionality changed from default theme
      ...
      //sections.register('slideshow', SlideshowSection);							//Removed - theme functionality changed from default theme
